...
## Model naming follows model_list_allsky_serial
## Amplitude and parameter order follows model_list_allsky_serial
...
def get_hd_fe( Nside, Npix ):
    ...
    # Appending in the order the parameters are read by the dictionary in model_list_allsky_serial
...
# Dictionary to be used in run_joint_mcmc_allsky_serial
