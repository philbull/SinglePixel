...
#Applies Reference Frequencie Table 1
I_cmb_scaling_factor = 50 / cmb2rj(30e9, model_list_experimental.cmb_model.scaling([30e9])[0])
I_sync_scaling_factor = 30 / cmb2rj(30e9, model_list_experimental.sync_model.scaling(30e9)[0])
I_ff_scaling_factor = 30 / cmb2rj(30e9, model_list_experimental.ff_model.scaling(30e9)[0])
I_ame_scaling_factor = 30 / cmb2rj(30e9, model_list_experimental.ame_model.scaling(30e9)[0])
I_dust_scaling_factor = 50 / cmb2rj(353e9, model_list_experimental.simple_dust_model.scaling(353e9)[0])

Q_cmb_scaling_factor = 0.6 / cmb2rj(30e9, model_list_experimental.cmb_model.scaling([30e9])[1])
Q_sync_scaling_factor = 10 / cmb2rj(30e9, model_list_experimental.sync_model.scaling(30e9)[1])
Q_dust_scaling_factor = 3.5 / cmb2rj(353e9, model_list_experimental.simple_dust_model.scaling(353e9)[1])
