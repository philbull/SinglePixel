...
initial_vals_sMBB2pMBB = (amp_I, amp_Q, amp_U, cmb.amp_I, cmb.amp_Q, cmb.amp_U,
                                sync.amp_I, sync.amp_Q, sync.amp_U, mean_beta, mean_temp,
                                                        1e-2, 5e-3, sync.sync_beta)
...
#pMBB_broad_single = single_fit(models_pMBB_broad, models_pMBB_narrow, initial_vals_pMBB_broad)
