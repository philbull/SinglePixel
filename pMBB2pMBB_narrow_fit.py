...
pMBB_narrow_single = single_fit(models_pMBB_narrow, models_pMBB_narrow, initial_vals_pMBB_intermediate, noiseless=True)
...
np.save('pMBB_narrow_single_noiseless', pMBB_narrow_single)
