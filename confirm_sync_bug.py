...
dust_model = models.DustGen(rj2cmb(353e9, DUST_I/2.), rj2cmb(353e9, DUST_P/2.1), rj2cmb(353e9, DUST_P/1.8) ,1.6,0.0,20.0,15.0,1.0,1.1,0.8)



#cmb_scaling_factor = 50 / cmb2rj(30e9, model_list_experimental.cmb_model.scaling(30e9)[0]) #Applies figure frequencies from Table 1
...
ff_scaling_factor = 30 / cmb2rj(30e9, model_list_experimental.ff_model.scaling(30e9)[0]) #Applies figure frequencies from Table 1
ame_scaling_factor = 30 / cmb2rj(30e9, model_list_experimental.ame_model.scaling(30e9)[0]) #Applies figure frequencies from Table 1
#dust_scaling_factor = 50 / cmb2rj(353e9, dust_model.scaling(353e9)[0]) #Applies figure frequencies from Table 1
dust_scaling_factor = 1
