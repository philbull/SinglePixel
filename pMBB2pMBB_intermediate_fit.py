...
initial_vals_pMBB_intermediate = cp.deepcopy(params_pMBB_intermediate)
...
pMBB_intermediate_single = single_fit(models_pMBB_intermediate, models_pMBB_intermediate, initial_vals_pMBB_intermediate, noiseless=True)
...
np.save('pMBB_intermediate_single_noiseless', pMBB_intermediate_single)
